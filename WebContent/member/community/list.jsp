		...
		<div class="contents">
			...
			<div id="search-container">
				<div id="search-wrapper">
					<h2 class="hidden">자유게시판 검색 폼</h2>
		
					<form id="search-form">
						<fieldset>
							<legend class="hidden">자유게시판 검색 필드</legend>
				...
				<table id="board">
					...
					<tbody>
						<tr class="board-row">
							...
							<td class="board-cell titles"><a href="">동해물과 백두산이 동해물과
						...
						<tr class="board-row">
							...
							<td class="board-cell titles"><a href="">마르고 닳도록 하느님이</a></td>
							<td class="board-cell writer">홍길동</td>
							<td class="board-cell date">2011-11-11</td>
						...
						<tr class="board-row">
							...
							<td class="board-cell titles"><a href="">보우하사 우리나라 만세</a></td>
							<td class="board-cell writer">홍길동</td>
							<td class="board-cell date">2011-11-11</td>
