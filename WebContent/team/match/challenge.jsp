...
<link href="../../css/match_style.css" rel="stylesheet" type="text/css">
</head>
	...
	<div id="center">
		...
		<body id="body">
			<form method=post action="ad_write.jsp">
				...
				<div class="title">
					<h2>
						도전 요청 팀<input type="submit" value="등록">
					</h2>
				</div>
				...
				<table align="center">
					<tr>
						<td><a href="ad_detail.jsp"><img src=" " alt="팀1">2013
								11월 15일(금)<br> 오후 8시 대한민국 서울월드컵경기장</a></td>
						<td><a href="ad_detail.jsp"><img src=" " alt="팀2">2013
								11월 15일(금)<br> 오후 8시 대한민국 서울월드컵경기장</a></td>
					</tr>
					<tr>
						<td><a href="ad_detail.jsp"><img src=" " alt="팀3">2013
								11월 15일(금)<br> 오후 8시 대한민국 서울월드컵경기장</a></td>
						<td><a href="ad_detail.jsp"><img src=" " alt="팀4">2013
								11월 15일(금)<br> 오후 8시 대한민국 서울월드컵경기장</a></td>
					</tr>
				</table>
				</div>
